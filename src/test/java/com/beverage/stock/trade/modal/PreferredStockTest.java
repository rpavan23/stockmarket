...
public class PreferredStockTest {
	...
	public void testDividendYield(){
		Stock stock = new PreferredStock("GIN", new BigDecimal(8), new BigDecimal(2), new BigDecimal(60) );
		BigDecimal dividendYield = stock.getDividendYield( new BigDecimal(40 ));
		Assert.assertEquals( new BigDecimal(0.03).setScale(3, RoundingMode.HALF_UP), dividendYield);
	}
	...
	public void testPERatio(){
		...
		Assert.assertEquals( new BigDecimal(1333.333).setScale(3, RoundingMode.HALF_UP), peRatio);
	}
	
	@Test
	public void testVolumeWeightedStockPrice(){
		Stock stockOne = new PreferredStock("GIN", new BigDecimal(23), null, new BigDecimal(60) );
